...
ggsave(filename = "~/Documents/Scheduled-Arrivals/Thesis/Figures/Static_Line_Interarrival_Gamma.eps",
       width = 20, height = 10,
       plot =
         ...
         theme(axis.text.x = element_text(size = 24), axis.text.y = element_text(size = 24),
               ...
               legend.title = element_text(size = 28), legend.text = element_text(size = 24), legend.position = "top")
         )
