...
In a similar way to Chapter~\ref{chap:Static}, the expected cost of each state $(n, k)$ is found using $\texttt{scipy.optimize.minimize}$ in Python. The results are plotted in Figure~\ref{fig:Dynamic_Cost_15}.
\begin{figure}[htb]
	\centering
